...
{
    public partial class form_GestionReflexologia : Form
    {
        public form_GestionReflexologia()
        {
            InitializeComponent();
        }

        private void form_GestionReflexologia_Load(object sender, EventArgs e)
        {
        ...
        private void btnConfirmar_Click(object sender, EventArgs e)
        {
            ...
            if (crear)
            {
                Servicio s = new Servicio(stringCaracteres("Reflexología"), stringCaracteres(cbDuracion.Text),
        ...
        private void form_RegistroReflexologia_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (guardar)
            {
